        ...
        <div className={styles.example}>
          ...
          <div className={styles.features}>
            ...
            <div className={styles.feature}>
              <div className={styles.nameWrap}><div className={styles.name1}>{ featureName1 }</div></div>
              <img src={feature1} alt={featureAlt1} className={styles.imageFeature} />
            </div>
            <div className={styles.feature}>
            <div className={styles.nameWrap}><div className={styles.name2}>{ featureName2 }</div></div>
              <img src={feature2} alt={featureAlt2} className={styles.imageFeature} />
            </div>
            <div className={styles.feature}>
            <div className={styles.nameWrap}><div className={styles.name3}>{ featureName3 }</div></div>
