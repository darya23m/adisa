export default {
  ...
  quality: {
    ...
    description: [ // +b resizable
      "<b>Теплообменник</b> котла ADISA изготовлен <b>из качественной нержавеющей стали EN 1.4509</b> (AISI344), трубчатая конструкция снижает сопротивление и риск засорения. Нет особых требований к качеству теплоносителя, в отличии от теплообменников, изготовленных из алюминия или обычной котловой стали.",
