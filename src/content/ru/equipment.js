export default {
  ...
  data: [ // resizable
    ...
    // ========== condensa-pro ==========
    {
      ...
      features: [ // resizable
        "Condexa PRO — это новое предложение от ADISA, представляющее собой модульную настенную конденсационную систему. Она может иметь открытую или закрытую камеру сгорания, состоять из одиночного котлоагрегата или работать в каскаде общей мощностью 1120 кВт.<br>",
