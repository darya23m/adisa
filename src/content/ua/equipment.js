  ...
  data: [ // resizable
    // ========== adi-lt ==========
    {
      ...
      features: [ // resizable
        ...
        "・Теплообмінник котла виготовлений з нержавіючої сталі. Відмінна стійкість до корозії та високої температури.",
    ...
    // ========== adi-mega ==========
    {
      ...
      features: [ // resizable
        ...
        "・Модуль складається з двох незалежних котлів. Кожен котел поставляється зі своїм паспортом. Не потрапляє під обмеження потужності в 1250кВт.",
    ...
    // ========== condensa-pro ==========
    {
      ...
      features: [ // resizable
        ...
        "・Кожен котел оснащений інноваційним спіральним теплообмінником запатентованої геометричної форми. Він складається з концентричних гладких труб з нержавіючої сталі п'ятикутного перетину зсередини і круглого зовні, збільшують теплообмінну поверхню і забезпечують максимальну стійкість до корозії.",
        "・У моделі з приставкою P встановлено насос з частотним регулюванням. Базова електроніка управляє погодозалежно. характеристикою, каскадною роботою котлових модулів, функцією ведучого / ведомого пристрою, автоматичним перемиканням режимів «Літо» / «Зима», а також прямою зоною та бойлером ГВП.",
