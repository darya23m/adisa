export default {
  ...
  quality: {
    ...
    description: [ // +b resizable
      ...
      "Не має потреби в підтримці температури зворотного теплоносія вище 60 градусів, як у класичних жаротрубних котлах. (Економія на триходовому клапані із сервоприводом та автоматикою або підмішуючому насосі). Чим нижче температура зворотного теплоносія, тим вище ефективність котла.",
